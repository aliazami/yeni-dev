...
from app.constants import SETTINGS, KEY_ID, KEY_TYPE, PART_ITEM, KEY_RECT_ID, KEY_RECT_TEXT, WORD_BOUNDARY_ITEM
from app.models import ISerializable


class WordBoundaryItem(QGraphicsRectItem, ISerializable):

    def __init__(self, part_id: str, item_id: str, word: str,  pos: QPointF, w: float, h: float):
